...
def get_config_for_training_free_calculator(search_space, dataset, path_data, seed, link, num_train_per_class, hp, in_dim, out_dim, tf):
    config = {
...
def get_training_free_calculator(config, method_type):
    ...
    elif method_type == 'jacob_cov':
        predictor = ZeroCostV2(config, batch_size=64, method_type='jacob_cov')
